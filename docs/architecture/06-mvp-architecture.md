...
> **Updated:** 2026-08-25 — деплой мен дерекқор бөлігі ЕСКІРДІ, төмендегі
> ескертпені оқы.

> ⚠️ **Бұл құжаттың бір бөлігі әлі жүзеге аспаған жоспар.**
>
> Хостинг PHP-only болып шыққандықтан ([ADR-0002b](../decisions/0002b-static-export-on-shared-hosting.md))
> қазіргі шындық басқа: сайт **статикалық экспорт**, лидті `api/leads.php`
> қабылдайды, дерекқор жоқ — өтінім `leads.jsonl` файлына жазылады.
>
> Демек төмендегі **PostgreSQL, Prisma, Auth.js, Docker + Nginx** жолдары
> қазір қолданылмайды. Олар CRM фазасына арналған жоспар күйінде қалады,
> ал CRM бірінші клиент келгенде ғана басталады. Дерекқор моделі мен
> беттер картасы күшінде — ескіргені тек деплой мен сақтау қабаты.
...
> `/cases` бөлімі кодта бар, бірақ жарияланған кейс жоқта **404 қайтарады**:
> бос бет те, ойдан шығарылған кейс те жарамайды. Ішінде тек заготовкалар
> тұр (`draft: true`) — прод ортада көрінбейді, sitemap-қа кірмейді
> ([ADR-0003](../decisions/0003-experience-led-positioning.md)).
