...
export function StickyContact() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 items-center gap-2 rounded-full bg-nur px-5 font-semibold text-ink shadow-lg shadow-black/40 transition-transform hover:scale-105"
    >
