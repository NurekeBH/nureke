...
export default function ServicesPage() {
  return (
    <Section
      ...
      titleAs="h1"
      lede="Мы сознательно ограничили себя тремя направлениями. Студия, которая делает всё сразу, обычно не делает хорошо ничего — а вам нужен результат, а не широкий прайс."
    >
